...
function PresentationContent() {
  ...
  const nextSlide = useCallback(() => {
    if (
      selectedTopic &&
      currentSlide < selectedTopic.presentationSlides.length - 1
    ) {
    ...
    return (
      <main className="min-h-screen relative overflow-hidden bg-black text-white selection:bg-blue-500/30">
        ...
        <div className="absolute inset-0 bg-[#050505] z-0">
          {/* Grid Pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#1f2937_1px,transparent_1px),linear-gradient(to_bottom,#1f2937_1px,transparent_1px)] bg-size-[4rem_4rem] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20" />
          {/* Deep Radial Glow */}
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex flex-col justify-center">
          <div className="max-w-5xl mx-auto w-full">
            ...
            <div className="text-center mb-16 relative">
              ...
              <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tighter text-transparent bg-clip-text bg-linear-to-b from-white to-white/50 drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                DATA MODULES
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Ubuntu OS Scrollytelling Deck */}
              <Link
                href="/presentation/ubuntu"
                className="group relative cursor-pointer"
              >
                {/* Hover Glow */}
                <div className="absolute -inset-1 bg-linear-to-r from-orange-500 to-red-600 rounded-xl opacity-20 group-hover:opacity-70 blur-md transition-opacity duration-500" />
                ...
                <div className="relative h-full bg-black/40 backdrop-blur-xl border border-white/10 p-8 rounded-xl overflow-hidden transition-all duration-300 group-hover:border-white/30 group-hover:translate-y-[-2px]">
                  ...
                  <div className="flex items-start gap-6">
                    <div className="text-4xl p-4 bg-white/5 rounded-lg border border-white/10 text-orange-400 group-hover:text-white group-hover:shadow-[0_0_20px_rgba(233,84,32,0.4)] transition-all duration-300">
                      🐧
                    </div>
                    <div>
                      ...
                      <p className="text-gray-400 group-hover:text-gray-300 leading-relaxed mb-4">
                        Interactive scrollytelling presentation detailing Ubuntu
                        architecture, boot sequence, commands, and OS
                        comparison.
                      </p>
              ...
              >
                {/* Hover Glow */}
                <div className="absolute -inset-1 bg-linear-to-r from-blue-500 to-purple-500 rounded-xl opacity-20 group-hover:opacity-70 blur-md transition-opacity duration-500" />
                ...
                <div className="relative h-full bg-black/40 backdrop-blur-xl border border-white/10 p-8 rounded-xl overflow-hidden transition-all duration-300 group-hover:border-white/30 group-hover:translate-y-[-2px]">
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 group-hover:text-gray-300 leading-relaxed mb-4">
                        An interactive 3D journey through Operating System
                        Memory Management.
                      </p>
    ...
    <main className="min-h-screen relative overflow-hidden bg-black text-white flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center pt-20 pb-24 px-8">
        ...
        <div className="max-w-5xl w-full p-12 relative rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm shadow-[0_0_100px_rgba(0,0,0,0.5)]">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-16 text-center tracking-tight bg-linear-to-r from-cyan-300 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(6,182,212,0.3)]">
            {slide.title}
          </h2>
          ...
          <ul className="space-y-8">
            {slide.points.map((point, i) => (
              ...
              >
                <span className="shrink-0 w-8 h-8 md:w-10 md:h-10 border border-blue-500/40 text-blue-300 rounded flex items-center justify-center font-mono text-sm md:text-base group-hover:bg-blue-500/20 group-hover:border-blue-400 transition-all">
                  {String(i + 1).padStart(2, '0')}
                </span>
                <span className="pt-1 group-hover:text-white transition-colors">
                  {point}
                </span>
              </li>
            ))}
            ...
            {selectedTopic.presentationSlides.map((_, i) => (
              <div
                ...
                className={`h-1 cursor-pointer transition-all duration-300 rounded-full ${
                  i === currentSlide
                    ? 'w-12 bg-linear-to-r from-cyan-500 to-blue-500 shadow-[0_0_10px_rgba(6,182,212,0.5)]'
